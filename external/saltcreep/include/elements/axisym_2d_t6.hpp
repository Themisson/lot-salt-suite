...
// 2D axisymmetric 6-node quadratic triangle in (r,z).
// Reference nodes: (0,0), (1,0), (0,1), (1/2,0), (1/2,1/2), (0,1/2).
class AxisymT6 : public Element {
public:
    AxisymT6();
